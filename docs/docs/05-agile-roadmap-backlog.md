...
**In progress:** July 16, 2026. Calm-dawn, dusk and night geometry-matched production candidates plus optimized WebP derivatives are recorded in the scene asset manifest. The active-overcast plate, reusable layers, city-light treatment and AVIF delivery are still open.
